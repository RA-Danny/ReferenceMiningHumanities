...
def character_embedding_layer(layer_type, character_input, maxChar, nbr_chars, char_embedding_size, 
                            cnn_kernel_size=2, cnn_filters=30, lstm_units=25, dropout=0.5):
    """
    ...
    if layer_type == "BILSTM":
        char_emb        = TimeDistributed(Bidirectional(LSTM(lstm_units,return_sequences=True)))(dropout)
    
    return TimeDistributed(Flatten())(char_emb)
