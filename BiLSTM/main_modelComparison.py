...
models = []
models.append({"name":"task1_crf",     "type":"crf",	 "epoch":25, "batch":100, "dropout":0.5, "lstm_size":200})
models.append({"name":"task1_softmax", "type":"softmax", "epoch":25, "batch":100, "dropout":0.5, "lstm_size":200})


for model in models:
	models_results[model['name']] = BiLSTM_model( model['name'], True, model['type'],
												  ...
												  lstm_hidden=model["lstm_size"], nbr_epochs=model["epoch"], batch_size=model["batch"], dropout=model["dropout"],
