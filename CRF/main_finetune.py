...
# Load entire data
X_train_w, train_t1, train_t2, train_t3, train_t4 = load_data("data/train.txt")
X_test_w, test_t1, test_t2, test_t3 , test_t4= load_data("data/test.txt")


for task in ["t4", "t3", "t1"]: #Ordered according to increase computation time
